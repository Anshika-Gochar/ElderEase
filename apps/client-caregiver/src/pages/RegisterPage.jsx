...
import { Eye, EyeOff, Heart, User, Mail, Phone, Lock, Loader2 } from 'lucide-react'

/**
 * Caregiver registration page with matching split-screen layout.
 * Role is auto-set to 'caregiver'.
 */
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(
      registerUser({ ...form, role: 'caregiver' })
    )
      ...
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white/60 overflow-hidden flex flex-col md:flex-row min-h-[600px] animate-fade-in">
        ...
        <div className="hidden md:flex md:w-5/12 bg-gradient-to-br from-[#2BBD8E] to-[#23a07a] text-white flex-col justify-between p-10 relative overflow-hidden">
          ...
          <div className="my-auto space-y-6 relative z-10">
            ...
            <p className="text-[15px] text-white/90 leading-relaxed font-400">
              To keep connected with your dashboard, please sign in with your caregiver account credentials.
            </p>
            <div className="pt-2">
              <span className="block text-[13px] text-white/70 mb-3 uppercase tracking-wider font-600">Already have an account?</span>
              <Link
                to="/login"
        ...
        <div className="w-full md:w-7/12 p-8 md:p-10 flex flex-col justify-center bg-white">
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <p className="text-[14px] text-[#718096] mb-5 font-500">Join as a caregiver to monitor and support your loved ones.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5" noValidate>
              {/* Full Name */}
              <div>
                <label htmlFor="cg-reg-name" className="block text-[12px] font-600 text-[#4A5568] mb-1 uppercase tracking-wider">
                  Full name
                </label>
              ...
              {/* Email */}
              <div>
                <label htmlFor="cg-reg-email" className="block text-[12px] font-600 text-[#4A5568] mb-1 uppercase tracking-wider">
                  Email address
                </label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A0AEC0]">
              ...
              {/* Phone */}
              <div>
                <label htmlFor="cg-reg-phone" className="block text-[12px] font-600 text-[#4A5568] mb-1 uppercase tracking-wider">
                  Phone number <span className="font-400 text-[#718096]">(for SOS alerts)</span>
                </label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A0AEC0]">
                    <Phone size={18} />
              ...
              {/* Password */}
              <div>
                <label htmlFor="cg-reg-password" className="block text-[12px] font-600 text-[#4A5568] mb-1 uppercase tracking-wider">
                  Password
                </label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A0AEC0]">
              ...
              {/* Confirm Password */}
              <div>
                <label htmlFor="cg-reg-confirm" className="block text-[12px] font-600 text-[#4A5568] mb-1 uppercase tracking-wider">
                  Confirm password
                </label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A0AEC0]">
